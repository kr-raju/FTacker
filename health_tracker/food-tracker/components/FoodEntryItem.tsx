...
const FoodEntryItem: React.FC<FoodEntryItemProps> = ({
  ...
  // Load image if entry has imageId
  useEffect(() => {
        ...
        <div className="p-4">
          <div className="flex justify-between items-start">
            <div className="flex items-start space-x-3">
              <div className={`w-3 h-3 mt-1.5 rounded-full ${getTypeColor()}`}></div>
              <div className="flex-grow">
                ...
                <p className="text-sm text-gray-500">
                  {entry.time} • {entry.calories} calories
                </p>
                {entry.description && (
                ...
                {entry.waterIntake && entry.waterIntake > 0 && (
                  <p className="text-xs text-blue-500 mt-1">
                    {entry.waterIntake}ml water/liquid
                  </p>
                )}
              </div>
            </div>
